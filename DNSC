...
while True:
    ...
    print("Wait a moment, search the DNS address of this site......")
    import dns.resolver
    time.sleep(5)
    print("***************************")
    print("DNS resolution pointing: ")
    print("***************************")
    A_address = dns.resolver.query(URL, 'A_address')  # 指定查询类型为A记录
